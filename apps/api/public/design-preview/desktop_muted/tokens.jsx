...
// Muted palette — indigo accent softened, secondary colors desaturated toward graphite.
// Status colors stay recognizable but are muted (lower chroma), so the interface reads calm.

const ACCENTS = {
  indigo: { base: '#5B5FD6', deep: '#4B4FC2', soft: 'rgba(91,95,214,0.08)',  glow: 'rgba(91,95,214,0.20)' },
  slate:  { base: '#52525B', deep: '#3F3F46', soft: 'rgba(82,82,91,0.08)',   glow: 'rgba(82,82,91,0.20)' },
  steel:  { base: '#475569', deep: '#334155', soft: 'rgba(71,85,105,0.08)',  glow: 'rgba(71,85,105,0.20)' },
  sage:   { base: '#5C7A6B', deep: '#456558', soft: 'rgba(92,122,107,0.08)', glow: 'rgba(92,122,107,0.20)' },
  clay:   { base: '#9B6B5A', deep: '#7E5447', soft: 'rgba(155,107,90,0.08)', glow: 'rgba(155,107,90,0.20)' },
};

const DT = {
  accent:     ACCENTS.indigo.base,
  accentDeep: ACCENTS.indigo.deep,
  accentSoft: ACCENTS.indigo.soft,
  accentGlow: ACCENTS.indigo.glow,

  // Muted status colors — lower chroma, less saturated
  green:  '#4F8C6F',
  orange: '#B47A3A',
  red:    '#B4514A',
  blue:   '#5B5FD6',
  ...
  // Light — warmer neutrals, softer contrasts
  bg: '#F7F7F6',
  bgPane: '#FFFFFF',
  bgSidebar: '#F0F0EE',
  bgHover: 'rgba(0,0,0,0.025)',
  bgSelected: 'rgba(91,95,214,0.07)',
  label: '#1C1C1E',
  sec: '#5C5C60',
  ter: '#9A9A9E',
  quart: '#CFCFD2',
  sep: 'rgba(0,0,0,0.05)',
  sepStrong: 'rgba(0,0,0,0.09)',

  // Dark — near-black, low chroma
  d_bg: '#141416',
  d_bgPane: '#1C1C1F',
  d_bgSidebar: '#18181A',
  d_bgHover: 'rgba(255,255,255,0.035)',
  d_bgSelected: 'rgba(91,95,214,0.14)',
  d_label: '#F0F0F0',
  d_sec: '#A8A8AC',
  d_ter: '#76767A',
  d_quart: '#56565A',
  d_sep: 'rgba(255,255,255,0.055)',
  d_sepStrong: 'rgba(255,255,255,0.09)',
};
