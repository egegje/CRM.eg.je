...
const ACCENTS = {
  indigo: { base: '#6366F1', deep: '#4F46E5', soft: 'rgba(99,102,241,0.10)', glow: 'rgba(99,102,241,0.25)' },
  violet: { base: '#8B5CF6', deep: '#7C3AED', soft: 'rgba(139,92,246,0.10)', glow: 'rgba(139,92,246,0.25)' },
  pink:   { base: '#EC4899', deep: '#DB2777', soft: 'rgba(236,72,153,0.10)', glow: 'rgba(236,72,153,0.25)' },
  amber:  { base: '#F59E0B', deep: '#D97706', soft: 'rgba(245,158,11,0.10)', glow: 'rgba(245,158,11,0.25)' },
  emerald:{ base: '#10B981', deep: '#059669', soft: 'rgba(16,185,129,0.10)', glow: 'rgba(16,185,129,0.25)' },
  sky:    { base: '#3B82F6', deep: '#2563EB', soft: 'rgba(59,130,246,0.10)', glow: 'rgba(59,130,246,0.25)' },
  slate:  { base: '#52525B', deep: '#3F3F46', soft: 'rgba(82,82,91,0.10)',   glow: 'rgba(82,82,91,0.25)' },
};
...
const DT = {
  ...
  d_bgSelected: 'rgba(99,102,241,0.15)',
  d_label: '#FAFAFA',
  d_sec: '#A1A1AA',
  d_ter: '#71717A',
  d_quart: '#52525B',
  d_sep: 'rgba(255,255,255,0.06)',
  d_sepStrong: 'rgba(255,255,255,0.10)',
};
